...
- (void)sendData:(NSData *)data withOptions:(NSDictionary *)input callback:(RCTResponseSenderBlock)callback
{
  ...
  NSString* xT3 = @"2";
  [req setValue:xT3 forHTTPHeaderField:@"X-T3-Api-Version"];
  NSString* xT3App = @"2";
  [req setValue:xT3App forHTTPHeaderField:@"X-T3-App-Version"];
  NSString* xT3OS = @"iOS";
  [req setValue:xT3OS forHTTPHeaderField:@"X-T3-Api-Version"];
