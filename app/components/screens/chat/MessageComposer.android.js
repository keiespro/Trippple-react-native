...
class MessageComposer extends React.Component{
    ...
    render(){
      ...
      <View style={styles.messageComposer}>
        ...
        >
            <Text style={{ overflow:'visible',fontFamily:'omnes',
fontSize: giant ? 36 : 18, marginBottom:giant ? 0 : 0,alignSelf:'center', height: giant ? this.state.height : this.state.height, flex:1,color:colors.white, }} >{
                this.state.txt
            }</Text>
        </AnimatedTextInput>
        <Btn
