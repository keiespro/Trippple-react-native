...
class NewerCard extends React.Component {
  ...
  renderProfileVisible(){
    ...
    return (
      <View style={{width: DeviceWidth,}}>
        ...
        <ScrollView>
        <Header {...this.props} size={{width: this.state.width, height: this.state.height-160,borderRadius:12, overflow:'hidden',}}/>
  ...
  renderClosed(){
    ...
    return (
      <Image source={{uri: potential.user.image_url}} style={{height: DeviceHeight - 50, width: cardWidth}}>
