              ...
              <View style={{overflow: 'hidden',  marginTop: 20}}>
                ...
                >
                  ...
                  {hasContactsPermissions ?
                    <Image source={require('./assets/checkmarkWhiteSmall.png')}
                      resizeMode={Image.resizeMode.cover}
                      style={{height: 21, width: 30}}
                    /> : <View style={{backgroundColor: colors.darkGreenBlue40, height: 20, width: 20, borderRadius: 10, alignSelf: 'center'}} /> }
                </BoxyButton>
              </View>
            </View>
