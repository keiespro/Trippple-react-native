...
class UserProfile extends React.Component{
  ...
  return (
        ...
        <FakeNavBar
          ...
          customPrev={ <Image resizeMode={Image.resizeMode.contain} style={{margin:0,alignItems:'flex-start',height:12,width:12,marginTop:10}} source={require('../../assets/close.png')} />
          }
        />
      </View>
