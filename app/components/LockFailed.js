  ...
  render(){
    return (
      ...
      <View style={{padding:20,height:DeviceHeight,width:DeviceWidth,flex:1,justifyContent:'center',alignItems:'center'}}>
        ...
        <TouchableHighlight underlayColor={colors.mediumPurple} onPress={this.props.retry} style={{padding:20,backgroundColor:colors.sushi,width:DeviceWidth-50,borderRadius:8,marginTop:50}}><Text style={{color:colors.white,fontSize:24,textAlign:'center'}}>Retry</Text></TouchableHighlight>
