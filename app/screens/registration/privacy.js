...
import {StyleSheet, Text, TextInput, View, Image, Navigator, TouchableHighlight, Dimensions, TouchableOpacity, LayoutAnimation} from "react-native";
        ...
        <View style={styles.topWrap}>
          ...
          <TouchableHighlight
            ...
            <View style={[styles.privacyWrap,
              ...
              <Image
                source={this.state.selection == 'public' ? {uri: 'assets/ovalSelected@3x.png'} : {uri: 'assets/ovalDashed@3x.png'} }
          ...
          <TouchableHighlight
            ...
            <View style={[styles.privacyWrap,
              ...
              <Image
              source={this.state.selection == 'private' ? {uri: 'assets/ovalSelected@3x.png'} : {uri: 'assets/ovalDashed@3x.png'} }
                resizeMode={Image.resizeMode.contain}
                style={styles.cornerDot}
              />
            <View style={{
