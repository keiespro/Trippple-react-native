...
#import "RCTMaskableTextManager.h"
...
#import "RCTMaskableText.h"
#import "UIView+React.h"

@implementation RCTMaskableTextManager

RCT_EXPORT_MODULE()

- (UIView *)view
{
  return [RCTMaskableText new];
}
...
RCT_EXPORT_SHADOW_PROPERTY(textDecorationLine, RCTMaskableTextDecorationLineType)
...
- (RCTViewManagerUIBlock)uiBlockToAmendWithShadowView:(RCTShadowText *)shadowView
{
  ...
  return ^(RCTUIManager *uiManager, RCTSparseArray *viewRegistry) {
    RCTMaskableText *text = viewRegistry[reactTag];
